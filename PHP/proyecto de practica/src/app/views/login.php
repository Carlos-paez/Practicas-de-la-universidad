...
<head>
    ...
    <link rel="stylesheet" href="src/public/styles/target.css">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col s6 push-s0,5">
            <form class="form" method="POST" action="?pagina=ValidateLogin">
                <p id="heading">Login</p>
                <?php if (!empty($error)): ?>
                    <div class="error-message" style="color:#ef5350;text-align:center;margin-bottom:10px;font-size:14px"><?= htmlspecialchars($error) ?></div>
                <?php endif; ?>
                <div class="field">
                ...
                <div class="btn">
                    ...
                    <a class="button2" id="abrir">Stack</a>
                </div>
            </form>
        </div>
        ...
        <div class="col s6 push-l3">
            <div class="container_custom">
                <div class="terminal_toolbar">
                    ...
                    <p class="user">Carlos@admin: ~</p>
                    <button class="add_tab">+</button>
                </div>
                <div class="terminal_body">
                    <div class="terminal_promt">
                        <span class="terminal_user">Carlos@admin:</span>
